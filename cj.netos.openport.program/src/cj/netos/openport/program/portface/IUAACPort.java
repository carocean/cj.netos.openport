...
public interface IUAACPort extends IOpenportService {
    @CjOpenport(usage = "测试了", tokenIn = TokenIn.headersOfRequest, acl = {"allow *.role"})
    Map<Integer, TestArg> getAcl(@CjOpenportParameter(name = "list",defaultValue = "[{\"name\":\"cj\",\"age\":23},{\"name\":\"zxt\",\"age\":20}]",type = LinkedList.class, elementType = TestArg.class, usage = "吃了没") List<TestArg> list,
