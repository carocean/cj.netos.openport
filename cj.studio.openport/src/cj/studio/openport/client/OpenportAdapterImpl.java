...
class OpenportAdapterImpl implements IAdapterInterrupter {
    Class<?> openportInterface;
    IOutputer outputer;
    String portsUrl;
    String token;

    public OpenportAdapterImpl(IOutputer outputer, Class<?> openportInterface, String portsUrl, String token) {
